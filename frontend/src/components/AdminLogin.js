      ...
      <div className="max-w-md w-full space-y-6 sm:space-y-8 bg-white p-6 sm:p-8 rounded-lg shadow-lg border border-gray-200">
        <div>
          <div className="flex justify-center">
            <img src="/logo.png" alt="HP Management Logo" className="h-20 w-20 sm:h-24 sm:w-24 lg:h-28 lg:w-28" />
          </div>
          <h2 className="mt-4 sm:mt-6 text-center text-2xl sm:text-3xl font-bold text-blue-900">
            Admin Login
          </h2>
